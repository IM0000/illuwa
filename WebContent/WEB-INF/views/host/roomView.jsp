...
$(document).ready(function() {
	...
	if(adminStatus == 'W') {
		...
		$(".noticetext").html("관리자승인 대기중인 숙소입니다.<hr>").css("color", "orange");
	} else if(adminStatus == 'Y'){
		$(".complete").css("background-color", "green");
		$(".noticetext").html("관리자의 승인을 받은 숙소입니다. 마이페이지>예약관리에서 숙소예약을 관리할 수 있습니다.<hr>").css("color", "green");
